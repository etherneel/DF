...
const Registration = ({ id }) => {
  ...
  const { contract } = useContract(
    "0xE36c1b5dA750DBBB0457FF620aCEb5BBDe279857"
  );
  ...
  const { data: checkApproval, isLoading: isApprovalLoading } = useContractRead(
    USDTContract,
    "allowance",
    [address, "0xE36c1b5dA750DBBB0457FF620aCEb5BBDe279857"]
  );
  ...
  const approveTokens = async () => {
    setIsLoading(true);
    try {
      let spender = "0xE36c1b5dA750DBBB0457FF620aCEb5BBDe279857"; //contract address
